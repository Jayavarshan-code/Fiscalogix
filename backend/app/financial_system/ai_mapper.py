...
class AIFieldMapper:
    ...
    SYNONYM_BRAIN = {
        ...
        "destination_node": ["ship to", "destination", "receiver", "target dc", "end location", "to location", "consignee", "consignee city", "delivery city", "delivery location", "ship to city"],
        "current_status": ["status", "state", "shipping status", "tracking status", "condition", "shipment status"],
        "total_value_usd": [
            "value", "total amount", "amount usd", "gross value", "invoice value", "declared value",
            "freight value", "order value", "order amount", "shipment value", "cargo value",
            "consignment value", "load value", "goods value", "merchandise value",
            "shipment amount", "cargo amount", "revenue", "sale value", "sales value",
        ],
        "total_cost_usd": [
        ...
        "route": ["trade lane", "lane", "trade route", "shipping lane", "corridor", "route code", "shipping route", "transit route"],
